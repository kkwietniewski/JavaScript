...
//'2' + 2; //zwróci typ string z nazwą typu np. "string" czy "number" jak w przykładzie

typeof "tekst";
typeof '22';
typeof `grawis`; // również string
// let userName = "Kacper";
...
typeof null; // błędnie zwraca jako "object", ale to nie jest obiekt i nie można tego poprawić aktualizacjami ze względu na wsteczną kompatybilność.
